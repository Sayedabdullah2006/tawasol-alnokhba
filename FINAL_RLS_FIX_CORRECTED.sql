-- ==================================================
-- الحل النهائي المُصحح: تطبيق سياسات RLS في Supabase Dashboard
-- ==================================================
...
-- 4. إنشاء حساب إدارة افتراضي (بدون عمود email)
INSERT INTO profiles (id, role, full_name) VALUES
('11111111-1111-1111-1111-111111111111', 'admin', 'مدير النظام')
...
-- ملاحظة: جدول profiles يحتوي على الأعمدة التالية فقط:
-- id, full_name, phone, city, x_handle, role, created_at, updated_at