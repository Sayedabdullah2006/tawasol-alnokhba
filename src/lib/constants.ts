...
export const CATEGORIES: Category[] = [
  ...
  { id: 'graduation_project', nameAr: 'مشروع تخرج', icon: '📐', desc: 'مشروع تخرج جامعي مميّز', clientTypes: ['individual'] },
  ...
  { id: 'product', nameAr: 'منتج / موقع / تطبيق', icon: '🚀', desc: 'إطلاق أو تطوير منتج أو موقع أو تطبيق', clientTypes: ['individual', 'business'] },
...
export const EXTRAS = [
  ...
  { id: 'video', nameAr: 'تصميم مقطع فيديو شخصي موشن جرافيك', icon: '🎬', price: 400 },
...
export const REQUEST_STATUSES = {
  ...
  refund_pending: { label: 'استرجاع قيد المعالجة', color: 'orange' },
  refunded: { label: 'مسترجع', color: 'gray' },
  suspended: { label: 'معلق', color: 'gray' },
...
// ─── شروط قبول الخبر حسب الفئة (تُعرض في معالج الطلب) ───
export const CATEGORY_CONDITIONS: Record<string, string> = {
  inventions:  'أرفِق براءة الاختراع أو وثيقة تسجيل/إيداع الابتكار (الرقم + الجهة المانحة).',
  competitions:'أرفِق ما يثبت المركز (شهادة/نتائج رسمية/رابط الجهة المنظّمة) + اسم المسابقة وتاريخها.',
  books:       'أرفِق غلاف العمل + رقم الإيداع/ISBN أو دار النشر، وما يثبت التأليف.',
  certs:       'أرفِق صورة الشهادة واضحة مع الجهة المانحة وتاريخها.',
  graduation:  'أرفِق وثيقة التخرج من الجامعة + التخصص والجهة.',
  graduation_project: 'أرفِق ما يثبت مشروع التخرج (الوثيقة/التقييم/خطاب الجهة) + التخصص والجامعة.',
  appointment: 'أرفِق خطاب/قرار التعيين الرسمي + موافقة الجهة على النشر.',
  award:       'أرفِق ما يثبت الجائزة (شهادة/خطاب الجهة المانحة) + اسمها وتاريخها.',
  cv:          'تأكّد من صحة المعلومات، وأرفِق ما يدعم أبرز الإنجازات المذكورة.',
  product:     'أرفِق ما يثبت ملكية/تسجيل المنتج أو العلامة (سجل تجاري/علامة) + صور المنتج.',
  research:    'أرفِق البحث المنشور أو ما يثبت النشر (رابط المجلة/الناشر/DOI) + الجهة.',
  charity:     'أرفِق ترخيص/تسجيل المبادرة أو الجهة + موافقتها على النشر.',
  government:  'أرفِق خطاباً رسمياً من الجهة يعتمد المحتوى ويصرّح بالنشر.',
  events:      'أرفِق ما يثبت الفعالية (تصريح/جهة منظّمة) + موافقتها على النشر + التاريخ والمكان.',
  Others:      'أرفِق ما يثبت صحة المحتوى وأي موافقات لازمة من الجهات المذكورة.',
}
