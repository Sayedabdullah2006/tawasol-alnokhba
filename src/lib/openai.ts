...
استثناء التهاني والمناسبات: لا تحوّلها إلى إنجاز أو بطاقات حقائق. اقترح توزيعاً بصرياً للتهنئة والشعار والصورة فقط. أي كلمات تصف التخطيط في brief هي تعليمات داخلية ولا تُطبع على البوستر.
