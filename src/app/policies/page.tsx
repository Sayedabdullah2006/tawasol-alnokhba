...
const sections = [
  ...
  },
  {
    ...
    items: [
      {
        head: 'السياسة التفصيلية',
        body: 'تتوفر سياسة الاسترجاع واسترداد المبالغ التفصيلية في صفحة مستقلة، وتوضح الحالات التي تُدرس، وآلية القرار، والمدد التقديرية بحسب وسيلة الدفع.',
      },
    ],
  },
]
