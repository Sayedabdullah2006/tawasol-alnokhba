    ...
    <div className="relative overflow-hidden pb-12">
      ...
      <section className="mx-auto max-w-6xl px-4 pt-12 md:pt-16">
        <div className="glass-panel relative min-h-[430px] overflow-hidden rounded-lg md:min-h-[360px]">
          ...
          <div className="relative z-10 flex min-h-[430px] items-end p-6 sm:p-8 md:min-h-[360px] md:items-center md:p-10 lg:p-12">
            <div className="w-full max-w-xl text-right md:ml-auto md:w-[56%]">
              ...
              <h2 className="mt-4 text-3xl font-black leading-tight text-dark md:text-4xl lg:text-[2.65rem]">خدمات رقمية تحوّل اختراعك إلى قصة واضحة قابلة للعرض</h2>
